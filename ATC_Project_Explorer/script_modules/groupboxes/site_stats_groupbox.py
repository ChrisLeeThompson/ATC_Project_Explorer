...
class SiteStatsGroupBox(QGroupBox):
    ...
    def _setup_layout(self):
        ...
        main_layout.addWidget(self.target_thickness_result_label, 0, 1)
        main_layout.addWidget(self.milling_angle_label, 1, 0)
        main_layout.addWidget(self.milling_angle_result_label, 1, 1)
        main_layout.addWidget(self.lamella_width_label, 2, 0)
        main_layout.addWidget(self.lamella_width_result_label, 2, 1)
        main_layout.addWidget(self.duration_label, 3, 0)
        main_layout.addWidget(self.duration_result_label, 3, 1)
        main_layout.addWidget(self.duration_without_placement_label, 4, 0)
        main_layout.addWidget(self.duration_without_placement_result_label, 4, 1)
        main_layout.addWidget(self.lamella_placement_duration_label, 5, 0)
        main_layout.addWidget(self.lamella_placement_duration_result_label, 5, 1)
        main_layout.addWidget(self.preparation_duration_without_placement_label, 6, 0)
        main_layout.addWidget(self.preparation_duration_without_placement_result_label, 6, 1)
        main_layout.addWidget(self.milling_duration_label, 7, 0)
        main_layout.addWidget(self.milling_duration_result_label, 7, 1)
        main_layout.addWidget(self.thinning_duration_label, 8, 0)
        main_layout.addWidget(self.thinning_duration_result_label, 8, 1)
        main_layout.addWidget(self.delay_duration_label, 9, 0)
        main_layout.addWidget(self.delay_duration_result_label, 9, 1)
