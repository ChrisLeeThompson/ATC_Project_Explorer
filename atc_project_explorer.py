...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event: QCloseEvent) -> None:
        ...
        if self._worker_thread is not None:
            ...
            if not self._worker_thread.wait(5000):
                logger.warning(
                    "Worker thread did not stop within 5s of "
    ...
    def _on_data_loaded(self):
        ...
        self.header_groupbox.set_project_root(self._project_root)

        # Hand off preloaded media so the global panel consumes it
